...
Find the nearest [Sunset Boulevard](https://sunset-boulevard.dk/) restaurant for anyone in your household. Home Assistant shows its address and how far away it is, puts it on the map, and can tell you when someone arrives there.
